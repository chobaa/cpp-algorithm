...
#define FOV_in_Y 60.0f
#define ORTHO_WIN 6.0f
...
void keyboard(unsigned char key, int x, int y) {
	...
	case 'o':
		...
		ProjectionMatrix = glm::ortho(-ORTHO_WIN*window_aspect_ratio, ORTHO_WIN*window_aspect_ratio, 
			-ORTHO_WIN, ORTHO_WIN, 1.0f, 50.0f);
		glutPostRedisplay();
		break;
	case 'p':
		// perspective projection
		ProjectionMatrix = glm::perspective(FOV_in_Y*TO_RADIAN, window_aspect_ratio, 1.0f, 50.0f);
		glutPostRedisplay();
		break;
	case 'c' :
...
void reshape(int width, int height) {
	...
	ProjectionMatrix = glm::perspective(FOV_in_Y * TO_RADIAN, window_aspect_ratio, 
		1.0f, 50.0f);
...
//  ViewMatrix = glm::lookAt(glm::vec3(12.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
//	ViewMatrix = glm::lookAt(glm::vec3(12.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 1.0f));
//  ViewMatrix = glm::lookAt(glm::vec3(12.0f, 3.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
 	
}

void prepare_scene(void) {
	prepare_axes();
	// vertex coordinates only
...
int main(int argc, char *argv[]) {
	char program_name[64] = "Sogang CSE4170 CHAP2SEC3_GLSL_22";
